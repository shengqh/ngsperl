...
if("celda" %in% rownames(installed.packages()) == FALSE) {BiocManager::install("celda", update=FALSE, ask=FALSE, dependencies=TRUE)}
...
if("Matrix.utils" %in% rownames(installed.packages()) == FALSE) {BiocManager::install("cvarrichio/Matrix.utils", update=FALSE, ask=FALSE, dependencies=TRUE)}
if("R.utils" %in% rownames(installed.packages()) == FALSE) {BiocManager::install("R.utils", update=FALSE, ask=FALSE, dependencies=TRUE)}
if("RColorBrewer" %in% rownames(installed.packages()) == FALSE) {BiocManager::install("RColorBrewer", update=FALSE, ask=FALSE, dependencies=TRUE)}
...
if("parallel" %in% rownames(installed.packages()) == FALSE) {BiocManager::install("parallel", update=FALSE, ask=FALSE, dependencies=TRUE)}
