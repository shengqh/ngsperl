...
# mgeneexp=reshape2::melt(geneExprTabR) |>
#   dplyr::rename(Tissue=variable, Exp=value) |>
#   dplyr::mutate(logExp=log2(Exp+1)) |>
#   dplyr::select(-Exp)

# g=ggplot(mgeneexp, aes(x=Tissue, y=logExp)) + 
#   geom_boxplot() +
#   ggtitle("Boxplot of gene expression values") + 
#   theme_bw3()

# ggsave(paste0(prefix, ".geneExpression_boxplot.png"), g, width = 12, height = 6, units = "in", dpi = 300, bg="white")
