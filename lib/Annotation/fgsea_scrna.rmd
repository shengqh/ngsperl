...
option_tbl=fread("fileList1.fgsea.txt", sep="\t", data.table=FALSE, header=FALSE)
...
file_tbl=fread("fileList2.fgsea.txt", sep="\t", data.table=FALSE, header=FALSE)
de_list_file=file_tbl$V1[1]
```

---
title: "FGSEA analysis of scRNA-seq DE results - `r task_name`"
author:
- name: "`r email`"
