...
cat("\nThere are total", nrow(tau_df), "genes and", ncol(tau_df), "tissues in the tau file.\n\n")
...
cat("\nThere are total", nrow(tabula_obj), "genes and", ncol(tabula_obj), "cells in the Tabula Sapiens snRNA dataset.\n\n")
