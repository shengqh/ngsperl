...
processGesaTable<-function(gseaTableFile,maxCategoryFdr=0.05,maxCategory=10,absLinkPath=FALSE) {
    ...
    figurePath<-list.files(dirname(gseaTableFile),pattern=paste0("enplot_",categoryName),full.names=TRUE)[1]
		figurePath<-R.utils::getRelativePath(figurePath,resultDir) #resultDir is outside this Rmd file, the location of result html file
		if (absLinkPath) {
