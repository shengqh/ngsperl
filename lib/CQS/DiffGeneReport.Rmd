...
diffDesignTable=read.csv(diffGeneFiles[diffDesignTableFileInd,1],row.names=1)
print(kable_styling(kable(diffDesignTable,caption = tabRef("design_table","Differential Detection Design Table"))))
```
...
print(kable_styling(kable(ComparisonsTableFile,caption = tabRef("comparisons_table","Differential Detection Comparisons"))))
```
...
print(kable_styling(kable(diffCriteriaTable,caption = tabRef("DEG_Criterias","DEG Criterias"))))
```
...
#  print(kable_styling(kable(output_table3, caption= tabRef("deseq2_table", paste0("DEG numbers under FC > ", rnaseqOptions["DE_fold_change", 1], " & ",pValueText," < ", rnaseqOptions["DE_pvalue", 1])))))
  print(kable_styling(kable(output_table3,caption = tabRef("DEG_number","DEG numbers"))))
}
...
#      cnames<-c("baseMean", "log2FoldChange","lfcSE", "stat", "pvalue", "padj", "FoldChange")
      ...
      print(kable_styling(kable(deseq2table, row.names=0, caption= tabRef(comparisonName, paste0(comparisonName, " top ", maxrow, " differential expressed genes")))%>% 
