...
parser.add_argument('-o', '--output', action='store', nargs='?', help="Output mismatch file name", required=False)

args = parser.parse_args()

logger = initialize_logger(args.output + ".log", 'bamMismatch', False)
