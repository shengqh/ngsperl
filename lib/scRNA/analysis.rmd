...
pool_sample<-ifelse(options$pool_sample == "0", FALSE, TRUE)
batch_for_integration<-ifelse(options$batch_for_integration == "0", FALSE, TRUE)
by_integration<-ifelse(options$by_integration == "0", FALSE, TRUE)
by_sctransform<-ifelse(options$by_sctransform == "0", FALSE, TRUE)

hto_str = ""
hto_data = list()
hto_sample_file<-options$hto_sample_file
...
```{r qc2_1, fig.height=10, fig.width=13, fig.cap=figRef("qc_metrics_2_1", "Density plot of number of read vs percentage of mitochondrial")}
...
```{r qc2_2, fig.height=10, fig.width=13, fig.cap=figRef("qc_metrics_2_2", "Density plot of number of feature vs percentage of mitochondrial")}
