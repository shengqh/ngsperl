...
if(isCalc){
  ...
  sumcounts=get_cluster_matrix(GetAssayData(obj,assay="RNA",slot="counts"), obj@active.ident)
...
if(length(samples) < 3){
  ...
  sampleHeight=min(13, ceiling(length(samples) / 3) * 5)
}
```
