...
hasBiomarker<-file.exists(files$celltype_max_markers_csv)
...
max_markers<-read.csv(files$celltype_max_markers_csv)
...
```{r gene_activity_group_umap, fig.width=12, fig.height=8, results="asis", fig.cap=figRef("umap_cluster_cell_group", "Predicted cell types by groups")}
...
```{r cluster_marker_heatmap, fig.width=12, fig.height=8, results="asis", fig.cap=figRef("cluster_marker_heatmap", "Cluster marker genes heatmap")}
