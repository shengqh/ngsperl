...
num_cell_file = paste0(detail_folder, outFile, ".num_cell.csv")
...
in_cluster_rmd<-function(edgeR_files, comparisons){
  ...
  for(comp in comparisons){
    ...
    result<-paste0(result, "\n## Number of DE genes\n\n")
    num_sig_file = paste0(detail_folder, comp, ".num_sig.csv")
    ...
    for(ct in cts){
      ...
      mds_png<-paste0(detail_folder, ct_comp_name, ".mds.png")
      if(file.exists(mds_png)){
        result<-paste0(result,"\n### MDS\n\n")
        result<-paste0(result, getFigure(mds_png))
      }

      heatmap_png<-paste0(detail_folder, ct_comp_name, ".log_cpm.heatmap.png")
      ...
      if(nrow(sig_data) == 0){
        ...
        top_gene_png<-paste0(detail_folder, ct_comp_name, ".top_1_gene.png")
