...
ggsave(cell_numbers_png, plot = g, width = bar_width, height = bar_height, units = "in", dpi = 300, bg="white")
...
ggsave(cell_median_png, plot = g, width = bar_width, height = bar_height, units = "in", dpi = 300, bg="white")
...
ggsave(mean_read_png, plot = g, width = bar_width, height = bar_height, units = "in", dpi = 300, bg="white")
