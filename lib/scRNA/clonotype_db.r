...
parSampleFile3=''
parFile1=''
parFile2='/data/cqs/references/scrna/TCR_clonotypedatabases/McPAS-TCR.csv'
parFile3='/data/cqs/references/scrna/TCR_clonotypedatabases/TBAdb.csv'
parFile4='/data/cqs/references/scrna/TCR_clonotypedatabases/vdjdb.csv'
outputDirectory='.'
