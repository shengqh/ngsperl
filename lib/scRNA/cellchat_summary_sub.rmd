...
for(pathways.show in pathways){
  ...
  each_circle_png = paste0(prefix, ".pathway.", celltype_to_filename(pathways.show), ".chord.png")
  png(each_circle_png, width=circle_width, height=circle_height, units="in", res=300, bg="white")
  g=netVisual_aggregate(cellchat, signaling = pathways.show, layout = "chord")
  ignored=dev.off()

  pathway_content = paste0(pathway_content, getFigure_width_height(each_circle_png, FALSE, circle_width, circle_height))
}
