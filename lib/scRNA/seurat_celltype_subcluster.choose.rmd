...
figureRmd<-function(cts){
  ...
  for(ct in cts){
    ...
    ct_png<-paste0(outFile, ".umap.", celltype_to_filename(ct), ".png")
    if(file.exists(ct_png)){
      result<-paste0(result, getFigure(ct_png))
    }else{
      result<-paste0(result, "\n\tNo sub clustering UMAP\n\n")
    }
  }
  return(result)
}
...
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".cell_type.umap.png"))
```

## Marker genes

```{r, echo=FALSE}
include_graphics(paste0(outFile, ".cell_type.dot.png"))
```
...
```
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".cell_type.sample_celltype.png"))
```
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".cell_type.celltype_sample.png"))
```

## Cell type individual UMAP 

```{r, echo=FALSE}
include_graphics(paste0(outFile, ".cell_type.cell.png"))
```
...
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".seurat_cell_type.umap.png"))
```

## Marker genes

```{r, echo=FALSE}
include_graphics(paste0(outFile, ".seurat_cell_type.dot.png"))
```
...
```
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".seurat_cell_type.sample_celltype.png"))
```
```{r, echo=FALSE}
include_graphics(paste0(outFile, ".seurat_cell_type.celltype_sample.png"))
```

## Cell type individual UMAP 

```{r, echo=FALSE}
include_graphics(paste0(outFile, ".seurat_cell_type.cell.png"))
```
