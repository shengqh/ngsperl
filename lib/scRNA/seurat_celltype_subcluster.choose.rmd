...
#### Cell count in each subtype of each sample
...
#### Cell of each subtype crossing samples

```{r}
include_graphics(paste0(detailFile, ".seurat_cell_type.sample_celltype.png"))
```

#### Cell of each sample crossing subtypes
...
```{r, }
include_graphics(paste0(outFile, ".seurat_cell_type.top10.heatmap.data.png"))
```
