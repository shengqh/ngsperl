...
",
  ...
  my $gatk4_01_BaseRecalibrator = "gatk4_01_BaseRecalibrator";
  $config->{$gatk4_01_BaseRecalibrator} = {
    class => "CQS::ProgramWrapperOneToOne",
    perform => 1,
    target_dir => $target_dir . "/$gatk4_01_BaseRecalibrator",
    interpretor => "",
    program => "",
    check_program => 0,
    docker_prefix => "gatk4_",
...
",
  ...
  push(@$tasks, $gatk4_01_BaseRecalibrator); 

  my $gatk4_02_ApplyBQSR = "gatk4_02_ApplyBQSR";
...
",
    ...
    source_ref => $bam_task,
    source_join_delimiter => " ",
    parameterSampleFile2_ref => [ $gatk4_01_BaseRecalibrator, ".recal_data.csv" ],
    parameterFile1_ref => $gene_bed,
    output_arg => "",
  ...
  my $gatk4_03_HaplotypeCaller = "gatk4_03_HaplotypeCaller";
...
",
  ...
  my $gatk4_04_GenomicsDBImport = "gatk4_04_GenomicsDBImport";
...
",
  ...
  my $gatk4_05_GenotypeGVCFs = "gatk4_05_GenotypeGVCFs";
