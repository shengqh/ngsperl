...
sub getSmallRNAConfig {
	...
	my ( $config, $individual_ref, $summary_ref, $cluster, $source_ref ) =
	...
	push @individual,
	  ( "bowtie1_genome_1mm_NTA", "bowtie1_genome_1mm_notidentical" );
		...
		my $unmappedreads = {
			...
			unmappedReads => {
				...
				source_ref =>
				  [ "bowtie1_genome_1mm_NTA_smallRNA_count", ".mapped.xml" ],
				source2_ref =>
				  [ "bowtie1_genome_1mm_NTA_pmnames", ".pmnames\$" ],
...
'/scratch/cqs/zhaos/vickers/reference/rRna/SILVA_123_LSURef_tax_silva',
	...
	if ( defined $def->{pairs} ) {
		...
		push @summary,
		  (
			"top100Reads_deseq2", "tRNA_deseq2",
			"miRNA_deseq2",       "otherSmallRNA_deseq2"
		  );
