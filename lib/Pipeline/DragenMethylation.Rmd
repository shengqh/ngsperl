...
dragen_qc_sample_pattern <- myoptions$dragen_qc_sample_pattern
...
if(dragen_qc_sample_pattern != "") {
  dragen_qc = dragen_qc[grepl(dragen_qc_sample_pattern, dragen_qc$`Sample Name`),]
}
