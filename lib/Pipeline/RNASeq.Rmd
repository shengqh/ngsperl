...
Reads were trimmed to remove adapter sequences using Cutadapt (`r vmap['Cutadapt']`)[1] and aligned to the `r vmap['genome']` genome using STAR (`r vmap['STAR']`)[2]. 
...
[1]	Martin M: Cutadapt removes adapter sequences from high-throughput sequencing reads. EMBnetjournal 2011, 17:10-12. \
