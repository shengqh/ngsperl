...
```{r, echo=FALSE,results='asis', eval = "STAR_chromosome_png" %in% names(file_map), fig.align="center", fig.align="center", fig.cap=figRef("STAR_chromosome_png", "The reads mapped to each chromosome in each sample")}
