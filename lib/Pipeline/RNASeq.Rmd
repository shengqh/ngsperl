...
```{r, eval=has_feature_chromosome_png, , fig.align="center", fig.align="center", fig.cap=figRef("feature_no_chrM_chromosome_png", "The reads mapped to genes in each chromosome (no chrM) in each sample")}
...
figureRmd<-function(file_map, corNames, section, hca_gene_used){
  ...
  for(i in c(1:length(corNames))){
    ...
    biotype_png = gsub(".heatmap.png", ".biotype_perc.png", heatmap_png)
