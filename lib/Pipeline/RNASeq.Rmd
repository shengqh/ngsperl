...
for(comp in comparisons){
  ...
  for(category in categories){
    ...
    fgsea_content = paste0(fgsea_content, get_figure_description(paste(comparison, category, "fgsea_png"), category_enriched_png, paste("FGSEA plot of", comparison, "in", category)))
  }
}
