...
Reads were `r if(has_cutadapt){paste0("trimmed to remove adapter sequences using Cutadapt ", vmap['Cutadapt'], ")[1] and")}` 
aligned to the `r vmap['genome']` genome using STAR (`r vmap['STAR']`)[2]. 
