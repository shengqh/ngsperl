...
cat("## FGSEA Hallmark Gene Set Enrichment Analysis\n\n")
fgsea_file_list = files$V1[files$V2 == "report_fgsea"]
fgsea_files = read.csv(fgsea_file_list, row.names=1)
if(nrow(fgsea_files) > 0){
  fgsea_files$fgsea_file=paste0(dirname(fgsea_file_list), "/", fgsea_files$fgsea_file)
  fgsea_files$fgsea_png=paste0(dirname(fgsea_file_list), "/", fgsea_files$fgsea_png)
}

fgsea_content=""
i=1
for(i in 1:nrow(fgsea_files)){
  comparison = rownames(fgsea_files)[i]
  fgsea_content = paste0(fgsea_content, "\n### ", comparison, "\n\n")
  fgsea_content = paste0(fgsea_content, getPagedTable(fgsea_files$fgsea_file[i], row.names=1, escape=TRUE, digits=3, nsmall=2))
  fgsea_content = paste0(fgsea_content, "\n\n")
  fgsea_content = paste0(fgsea_content, get_figure_description(paste(comparison, "fgsea_png"), fgsea_files$fgsea_png[i], paste("FGSEA plot of", comparison)))
}
