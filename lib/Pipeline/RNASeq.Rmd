...
```{r hasFastqLen, eval=hasFastqLen, fig.align="center", fig.cap=figRef("fastqc_len_distribution", "The length distribution of sequencing reads", trunk.eval=file.exists(file_map$fastq_len_vis))}
...
```{r,echo=FALSE,results='asis', fig.align="center", fig.cap=figRef("correlation_density", "Expression density distribution of each sample", trunk.eval=is_file_exists(file_map$all_correlation_density))}
check_and_include_graphics(file_map$all_correlation_density)
```

```{r,echo=FALSE,results='asis', fig.align="center", fig.cap=figRef("correlation_density", "Expression density distribution of each sample", trunk.eval=is_file_exists(file_map$genetable_correlation.all_correlation_density))}
...
for(i in c(1:length(corNames))){
  ...
  if(file.exists(biotype_png)){
    similarity_content = paste0(similarity_content, "\n", indent, "# Gene biotype distribution\n\n", get_figure_description(paste(name, "biotype_png"), biotype_png, paste("Biotype distribution of", name, "samples")))
  }
