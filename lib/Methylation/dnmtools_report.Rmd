...
g3<-ggplot(dup_rate, aes(x=Sample, y=duplication_rate)) +
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle=90, vjust=0.5, size=11, hjust=0, face="bold"),
        axis.text.y = element_text(size=11, face="bold"))
print(g3)
...
# Methylation statistics in chromosomes

## BS convert rate statistics in chromosomes 

### The overall BS rate in chromosomes

```{r bs_summary,echo=FALSE,results='asis', warning = F, message = F, include = T, eval = T, fig.align="center", fig.cap=figRef("bs_summary", "The BS convert rate in chromosomes")}
pat <- ".bsrate$"
...
### The BS rates of Non-CpG and CpG sites in chromosomes

```{r bs_cpg_summary,echo=FALSE,results='asis', warning = F, message = F, include = T, eval = T, fig.align="center", fig.cap=figRef("bs_cpg_summary", "The BS convert rates of Non-CpG and CpG sites in chromosomes")}
...
## The statistics of methylation level in chromosomes

```{r methy_summary,echo=FALSE,results='asis', warning = F, message = F, include = T, eval = T, fig.align="center", fig.cap=figRef("methy_summary", "The statistics of methylation level in chromosomes")}
