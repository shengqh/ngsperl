...
parser = argparse.ArgumentParser(description="Find RNA editing word from fastq file.",
                                 formatter_class=argparse.ArgumentDefaultsHelpFormatter)

parser.add_argument('-i', '--input', action='store', nargs='?', required=NOT_DEBUG, help="Input fastq file")
parser.add_argument('-o', '--output', action='store', nargs='?', required=NOT_DEBUG, help="Output file")
parser.add_argument('-b', '--barcode', action='store', nargs='?', required=NOT_DEBUG, help="Sequence fasta file, should contain only one sequence")
